...
const SECTIONS = [
  {
    ...
    title: "Посмотрите!",
    icon: "Play",
    description: "Документальные фильмы, архивные хроники и видеолекции из коллекции музея",
    items: [
      "Документальный цикл «Культура и государство»",
      "Архивные кинохроники 1920–1991 гг.",
      "Видеолекции ведущих культурологов",
      "Репортажи о культурных событиях",
    ],
  },
  {
    id: "listen",
    ...
    title: "Послушайте!",
    icon: "Headphones",
    description: "Аудиозаписи, подкасты, радиопередачи и музыкальные архивы",
    items: [
      "Подкасты о культурной политике",
      "Радиопередачи советской эпохи",
      "Аудиозаписи конференций и дискуссий",
      "Музыкальные архивы государственных ансамблей",
    ],
  },
  {
    id: "read",
    ...
    title: "Почитайте!",
    icon: "BookOpen",
    description: "Документы, исследования, законодательные акты и научные публикации",
    items: [
      "Государственные программы и указы",
      "Научные статьи и монографии",
      "Архивные документы и письма",
      "Аналитические доклады и отчёты",
    ],
  },
]
