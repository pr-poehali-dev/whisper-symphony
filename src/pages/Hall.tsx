  ...
  diaspora: [
    {
      ...
      emoji: "🎬",
      title: "Посмотрите!",
      description: "Видеоматериалы о жизни русских общин за рубежом",
      materials: [],
    },
    {
      id: "listen",
      emoji: "🎧",
      title: "Послушайте!",
      description: "Аудиоматериалы о культурной жизни диаспор",
      materials: [],
    },
    {
      id: "read",
      emoji: "📖",
      title: "Почитайте!",
      description: "Исследования и документы о жизни русских диаспор в мире",
      materials: [],
    },
  ],
}
